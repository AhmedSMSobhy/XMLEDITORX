; Inno Setup 6 script, builds XMLEDITORX-Setup-1.0.0.exe from the published single file.
; 1. dotnet publish ... -o publish   (see README)      2. iscc installer\XMLEDITORX.iss

#define MyAppName "XMLEDITORX"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Ahmed SM Sobhy, KAIST IAM Group"
#define MyAppExeName "XMLEDITORX.exe"
...
SetupIconFile=..\src\XMLEDITORX\Resources\XMLEDITORX.ico
OutputDir=Output
OutputBaseFilename=XMLEDITORX-Setup-{#MyAppVersion}
Compression=lzma2
...
Name: "openwith"; Description: "Show XMLEDITORX in the ""Open with"" list for .xml files"; GroupDescription: "File types:"; Flags: unchecked
