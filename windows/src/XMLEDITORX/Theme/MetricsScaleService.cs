...
/// <see cref="RebuildFonts"/>. Persists to <c>XMLEDITORX.globalZoom</c>.
/// </summary>
public sealed class MetricsScaleService : INotifyPropertyChanged
{
    public const string PrefsKey = "XMLEDITORX.globalZoom";
    ...
    /// <see cref="XMFont.GlobalScale"/>, persists to <c>XMLEDITORX.globalZoom</c>, and fires both
