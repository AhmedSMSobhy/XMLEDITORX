...
{
    private const string PrefsKey = "XMLEDITORX.themeID";
    ...
    /// <c>XMLEDITORX.themeID</c>, and raise <see cref="ThemeChanged"/>.
    /// </summary>
    ...
    private static Uri ResourceUri(string id)
        => new($"/XMLEDITORX;component/Theme/Themes/{FileStem(id)}.xaml", UriKind.Relative);
