...
///
/// Keys per spec, e.g. main window, per-pane pop-outs (<c>XMLEDITORXPopout-&lt;title&gt;</c>),
...
{
    /// <summary>Composes the per-pane pop-out key used by the spec (<c>XMLEDITORXPopout-&lt;title&gt;</c>).</summary>
    public static string PopoutKey(string title) => "XMLEDITORXPopout-" + title;
