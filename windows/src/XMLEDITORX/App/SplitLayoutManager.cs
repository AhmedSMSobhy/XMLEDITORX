...
/// persistence of the minimized set to <c>XMLEDITORX.minimizedPaneTitles</c>. MainWindow registers
...
public sealed class SplitLayoutManager
{
    ...
    public const string MinimizedPanesKey = "XMLEDITORX.minimizedPaneTitles";
