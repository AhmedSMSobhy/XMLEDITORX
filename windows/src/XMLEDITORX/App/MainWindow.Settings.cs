...
{
    private const string ReopenRememberedKey = "XMLEDITORX.reopenChoiceRemembered";
    private const string LearnChatKey = "XMLEDITORX.learnChat";
    ...
    private void AskReopenPreferenceIfNeeded()
    {
        ...
        (int index, bool remember) = ShowAlert("Next time XMLEDITORX starts",
    ...
    {
        (int index, _) = ShowAlert("Reset XMLEDITORX to a fresh start?",
    ...
    XMLEDITORX.Theme.Theme ISettingsHost.CurrentTheme
    {
