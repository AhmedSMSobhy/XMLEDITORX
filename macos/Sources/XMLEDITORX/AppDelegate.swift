...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private static let recentFilesKey = "XMLEDITORX.recentFiles"
    ...
    private func askAboutReopeningIfNeeded() {
        ...
        a.informativeText = "You have files open. XMLEDITORX can bring them back the next time you start it."
    ...
    private func buildMenuBar() {
        ...
        appMenu.addItem(NSMenuItem(title: "About XMLEDITORX", action: #selector(AppDelegate.showAbout(_:)), keyEquivalent: ""))
        ...
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(NSMenuItem(title: "Hide XMLEDITORX", action: #selector(NSApplication.hide(_:)), keyEquivalent: "h"))
        let hideOthers = NSMenuItem(title: "Hide Others", action: #selector(NSApplication.hideOtherApplications(_:)), keyEquivalent: "h")
        hideOthers.keyEquivalentModifierMask = [.command, .option]
        appMenu.addItem(hideOthers)
        appMenu.addItem(NSMenuItem(title: "Show All", action: #selector(NSApplication.unhideAllApplications(_:)), keyEquivalent: ""))
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(NSMenuItem(title: "Quit XMLEDITORX", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
        ...
        reopenItem.toolTip = "When XMLEDITORX starts without a file, open the files you had open last time"
        ...
        shareMenu.addItem(NSMenuItem(title: "Copy Selection in Full (No XMLEDITORX Limit)",
        ...
        helpMenu.addItem(NSMenuItem(title: "About XMLEDITORX",
    ...
    @objc func menuResetAllSettings(_ sender: Any?) {
        let alert = NSAlert()
        alert.messageText = "Reset XMLEDITORX to a fresh start?"
