...
enum XMLDocumentError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .unsupportedEncoding:
            return "The file uses an unsupported text encoding. XMLEDITORX supports UTF-8, UTF-16, UTF-32, ASCII, ISO-8859-1, Windows-1252, and Mac Roman."
        case .unsupportedDeclaredEncoding(let name):
            return "The XML declaration names unsupported encoding '\(name)'. XMLEDITORX did not guess or change the document's bytes."
