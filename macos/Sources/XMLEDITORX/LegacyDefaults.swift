...
// The app has carried three earlier names; each rename changed the bundle
...
enum LegacyDefaults {
    // NEWEST FIRST. The copy below is first-wins, and all three old
    ...
    private static let doneKey = "XMLEDITORX.migratedLegacyDefaults.v3"
    ...
    static func migrateIfNeeded() {
        ...
        for hop in hops {
            ...
            for (key, value) in old {
                let newKey = key
                    .replacingOccurrences(of: hop.keyPrefix, with: "XMLEDITORX.")
                    .replacingOccurrences(of: hop.framePrefix, with: "XMLEDITORX")
